...
AzoftTest.factory("GMap",["$http",function(e){var t,n={LAT:55.00518863585595,LNG:82.9361343383789,ZOOM:12,DISPLAY_ZOOM:14,MAP_ID:"map_canvas"},r=function(e,t,r){var o=document.getElementById(n.MAP_ID);if(GBrowserIsCompatible()&&o){var l=new google.maps.Map(o);return l.setCenter(new GLatLng(e||n.LAT,t||n.LNG),r||n.ZOOM),l}return alert("Не найден елемент "+n.MAP_ID),!1};return{setMAP_ID:function(e){n.MAP_ID=e||n.MAP_ID},setLAT:function(e){n.LAT=parseFloat(e||n.LAT)},setLNG:function(e){n.LNG=parseFloat(e||n.LNG)},setZOOM:function(e){n.ZOOM=parseInt(e||n.ZOOM)},setDISPLAY_ZOOM:function(e){n.DISPLAY_ZOOM=parseInt(e||n.DISPLAY_ZOOM)},addPoint:function(n){t=r(),n&&t&&GEvent.addListener(t,"click",function(r,o){r||e.post("http://maps.google.com/maps/api/geocode/json?latlng="+o.lat()+","+o.lng()+"&sensor=false&language=ru").success(function(e){if("OK"===e.status&&e.results.length){var r=e.results[0].formatted_address;t.openInfoWindow(o,r),n.address=r,n.X=o.lat(),n.Y=o.lng()}else alert("Ошибка получения адреса по координатам")}).error(function(){alert("Не удалось соединиться с сервером")})})},displayPoint:function(e){if(t=r(e.coordinateX,e.coordinateY,n.DISPLAY_ZOOM),e&&t){var o="Точка: "+e.name+"<br>Адрес: "+e.address,l={lat:parseFloat(e.coordinateX),lng:parseFloat(e.coordinateY)};t.openInfoWindow(l,o)}else alert("Нет данных для отображения")}}}]);
